...
# | |/ |/ / _ `/ / / _ \/ _ `/ _ \/ -_) __/
# |__/|__/_/_,_/_/_/ .__/_/ ,_/ .__/_/\__/_/
#                /_/       /_/
...
if [ -f "$HOME"/.config/hypr/user_settings/wallpaper_cache ]; then
    use_cache=1
...
blurfile="$HOME/.config/hypr/user_settings/blur.sh"
defaultwallpaper="$HOME/.config/hypr/wallpapers/default.jpg"
wallpapereffect="$HOME/.config/hypr/user_settings/wallpaper-effect.sh"
blur="50x30"
blur=$(cat "$blurfile")

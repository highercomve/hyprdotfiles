#!/usr/bin/env bash
# shellcheck source=../user_settings/screenshot-filename.sh
# shellcheck source=../user_settings/screenshot-folder.sh
#                                 __        __
...
# Screenshot Filename
# shellcheck source=../user_settings/screenshot-filename.sh
source "$HOME"/.config/hypr/user_settings/screenshot-filename.sh

# Screenshot Folder
# shellcheck source=../user_settings/screenshot-folder.sh
source "$HOME"/.config/hypr/user_settings/screenshot-folder.sh

# Screenshot Editor
GRIMBLAST_EDITOR="$(cat ~/.config/hypr/user_settings/screenshot-editor.sh)"

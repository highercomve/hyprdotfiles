...
hl.bind(mainMod .. " + bracketright", hl.dsp.group.next(), { description = "Group: focus next tab" })
hl.bind(mainMod .. " + bracketleft",  hl.dsp.group.prev(), { description = "Group: focus previous tab" })
hl.bind(mainMod .. " + SHIFT + bracketright", hl.dsp.group.move_window({ forward = true }),  { description = "Group: move tab right" })
hl.bind(mainMod .. " + SHIFT + bracketleft",  hl.dsp.group.move_window({ forward = false }), { description = "Group: move tab left" })
